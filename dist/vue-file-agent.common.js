...
var upload_helper_UploadHelper = /** @class */ (function () {
    ...
    UploadHelper.prototype.addHeaders = function (xhr, headers) {
        ...
        var jwtToken = window.localStorage.getItem('b4u_jwtToken');
        if (headers) {
